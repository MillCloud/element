...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "el-transfer", class: { "is-flexable": _vm.flexable } },
    [
      _c(
        "transfer-panel",
        _vm._b(
      ...
      _c(
        ...
        [
          _c(
            "el-button",
            {
              staticClass: "el-transfer__button",
              attrs: {
                type: "primary",
            ...
            [
              _c("i", {
                ...
                class: { "el-icon--left": _vm.buttonTexts[0] }
              }),
              _vm._v("\n      " + _vm._s(_vm.buttonTexts[0]) + "\n    ")
            ]
          ),
          _vm.stackButton ? _c("div") : _vm._e(),
          _c(
            "el-button",
            {
              staticClass: "el-transfer__button",
            ...
            [
              _vm._v("\n      " + _vm._s(_vm.buttonTexts[1]) + "\n      "),
              _c("i", {
                staticClass: "el-icon-arrow-right",
                class: { "el-icon--right": _vm.buttonTexts[1] }
              })
            ]
          )
        ],
  ...
  return _c("div", { staticClass: "el-transfer-panel" }, [
    ...
    _c(
      "div",
      {
        ...
        class: { "is-with-footer": _vm.hasFooter }
      },
      [
        _vm.filterable
          ? _c(
