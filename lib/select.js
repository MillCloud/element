...
var render = function() {
  ...
  return _c(
    ...
    [
      _vm._t("default", [
        _c("span", { staticClass: "el-select-dropdown__item-label" }, [
...
/* harmony default export */ var optionvue_type_script_lang_js_ = ({
  ...
  computed: {
    isObject: function isObject() {
      return this.value && _typeof(this.value) === 'object';
    },
                ...
                ? [
                    _c(
                      "el-tag",
                      {
                        ...
                        class: { filterable: _vm.filterable },
                        attrs: {
...
var src_option = __webpack_require__(30);
...
/* harmony default export */ var selectvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    showNewOption: function showNewOption() {
      ...
      return this.filterable && this.allowCreate && this.query !== '' && !this.options.some(function (option) {
  ...
  methods: {
    handleComposition: function handleComposition(event) {
      ...
      if (event.type === 'compositionend') {
        ...
        this.isOnComposition = !Object(util_["isKorean"])(lastCharacter);
      }
    },
    ...
    getOption: function getOption(value) {
      var result = void 0;
      var isObject = value && (typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object';

      for (var i = this.options.length - 1; i >= 0; i--) {
        var option = this.options[i];
        var isEqual = isObject ? Object(util_["getValueByPath"])(option.value, this.valueKey) === Object(util_["getValueByPath"])(value, this.valueKey) : option.value === value;
        if (isEqual) {
          result = option;
          break;
        }
    ...
    onOptionCreate: function onOptionCreate(option) {
    ...
    getValueKey: function getValueKey(_ref) {
      var value = _ref.value;

      if (!value || (typeof value === 'undefined' ? 'undefined' : _typeof(value)) !== 'object') {
        return value;
      } else {
        return Object(util_["getValueByPath"])(value, this.valueKey);
      }
    }
  },
