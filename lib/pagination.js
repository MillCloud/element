...
var locale_ = __webpack_require__(16);
...
/* harmony default export */ var pagination = ({
  ...
  render: function render(h) {
    ...
    var TEMPLATE_MAP = {
      ...
      next: h('next'),
      sizes: h('sizes'),
      slot: h('slot', [this.$slots.default || '']),
      total: h('total')
    };
  ...
  components: {
    Prev: {
      ...
      render: function render(h, _ref) {
        ...
        return h(
          ...
          [parent.prevText ? h('span', [parent.prevText]) : h('i', { 'class': 'el-icon el-icon-arrow-left' })]
        );
      }
    },
    ...
    Next: {
      ...
      render: function render(h, _ref2) {
        ...
        return h(
          ...
          [parent.nextText ? h('span', [parent.nextText]) : h('i', { 'class': 'el-icon el-icon-arrow-right' })]
        );
      }
    },
      ...
      render: function render(h, _ref3) {
        ...
        return h(
          ...
          [h(
            ...
            [parent.pageSizes.map(function (item) {
              return h(option_default.a, {
                attrs: {
                  value: item,
                  label: item + Object(locale_["t"])('el.pagination.pagesize') }
              });
            })]
          )]
        );
    ...
    Jumper: {
      ...
      render: function render(h, _ref4) {
        ...
        return h(
          ...
          [Object(locale_["t"])('el.pagination.goto'), h(input_default.a, {
            ref: 'jumper',
          ...
          }), Object(locale_["t"])('el.pagination.pageClassifier')]
        );
      }
    },
    ...
    Total: {
      ...
      render: function render(h, _ref5) {
        ...
        return typeof parent.total === 'number' ? h(
          'span',
          { 'class': 'el-pagination__total' },
          [Object(locale_["t"])('el.pagination.total', { total: parent.total })]
        ) : null;
      }
    },
  ...
  methods: {
    ...
    emitChange: function emitChange() {
      ...
      this.$nextTick(function () {
        if (_this.internalCurrentPage !== _this.lastEmittedPage || _this.userChangePageSize) {
          _this.$emit('current-change', _this.internalCurrentPage);
          _this.lastEmittedPage = _this.internalCurrentPage;
          _this.userChangePageSize = false;
        }
      });
    }
  },
  ...
  watch: {
    ...
    pageSizes: {
      ...
      handler: function handler(newVal, oldVal) {
        if (!Object(util_["valueEquals"])(newVal, oldVal) && Array.isArray(newVal)) {
          this.internalPageSize = newVal.indexOf(this.pageSize) > -1 ? this.pageSize : this.pageSizes[0];
        }
      }
    },
