...
"use strict";
/* harmony import */ var element_ui_src_utils_dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
...
var poperMixins = Object(vue_popper_["customerPopper"])('reference');
...
var validator = function validator(val) {
  ...
  return val == null || typeof val === 'string' || Array.isArray(val) && val.length === 2 && val.every(function (x) {
    return typeof x === 'string';
  });
};

/* harmony default export */ var pickervue_type_script_lang_js_ = ({
  mixins: [emitter_default.a, poperMixins],
  ...
  methods: {
    ...
    mountPicker: function mountPicker() {
      ...
      this.$watch('clearable', function (clearable) {
        _this3.picker.clearable = clearable;
      }, { immediate: true });
