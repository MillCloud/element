            ...
            nativeOn: {
              keydown: [
                function($event) {
                  ...
                  return _vm.highlight(_vm.highlightedIndex - 1, $event)
                },
                function($event) {
                  if (
                    !$event.type.indexOf("key") &&
...
/* harmony default export */ var autocompletevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    getData: function getData(queryString) {
      ...
      this.loading = true;
      var done = function done(suggestions) {
        _this.loading = false;
      ...
      var result = this.fetchSuggestions(queryString, done);
    ...
    highlight: function highlight(index, event) {
  ...
  mounted: function mounted() {
    ...
    this.debouncedGetData = Object(external_throttle_debounce_["debounce"])(this.debounce, this.getData);
