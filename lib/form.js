...
var render = function() {
  ...
  return _c(
    "form",
    {
      ...
      class:
        ((_obj = {}),
        (_obj["el-form--label-" + _vm.labelPosition] = _vm.labelPosition),
        (_obj["el-form--inline"] = _vm.inline),
        (_obj["el-form--disabled"] = _vm.disabled),
        _obj)
    },
    [_vm._t("default")],
    2
  ...
  methods: {
    ...
    validate: function validate(callback) {
      ...
      this.fields.forEach(function (field) {
        field.validate('', function (message, field) {
          ...
          merge_default()(invalidFields, field);
    ...
    validateField: function validateField(props, cb) {
      ...
      if (typeof cb !== 'function') {
        ...
        var count = 0;
        promise = new window.Promise(function (resolve, reject) {
          cb = function cb(message, field) {
            if (message) isValid = false;
            merge_default()(result, field);
