...
/* harmony default export */ var date_tablevue_type_script_lang_js_ = ({
  ...
  computed: {
    prevMonthDatePrefix: function prevMonthDatePrefix() {
      ...
      temp.setDate(0);
      return Object(date_util_["formatDate"])(temp, 'yyyy-MM');
    },
    curMonthDatePrefix: function curMonthDatePrefix() {
      return Object(date_util_["formatDate"])(this.date, 'yyyy-MM');
    },
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    formatedDate: function formatedDate() {
      return Object(date_util_["formatDate"])(this.date, 'yyyy-MM-dd');
    },
    ...
    formatedToday: function formatedToday() {
      return Object(date_util_["formatDate"])(this.now, 'yyyy-MM-dd');
    },
