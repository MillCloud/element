...
var image_viewervue_type_template_id_5e73b307_render = function() {
  ...
  return _c(
    ...
    [
      _c("div", {
        ...
        on: {
          click: function($event) {
            _vm.closeOnClickModal && _vm.onClose()
          }
        }
      }),
        ...
        [
          _c("div", { staticClass: "el-image-viewer__actions__inner" }, [
            ...
            _c("i", {
              ...
              on: {
                click: function($event) {
                  return _vm.handleActions("rotateLeft")
                }
              }
            }),
            _c("i", {
              ...
              on: {
                click: function($event) {
                  return _vm.handleActions("rotateRight")
                }
              }
            })
          ])
      ...
      _c("div", { staticClass: "el-image-viewer__canvas" }, [
        _c("img", {
          key: _vm.currentImg,
          ref: "img",
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    imageIndex: function imageIndex() {
      var itemIndex = this.previewSrcList.indexOf(this.src);
  ...
  mounted: function mounted() {
    var img = this._loadingImage = new Image();
  ...
  methods: {
    ...
    addLazyLoadListener: function addLazyLoadListener() {
      ...
      if (_scrollContainer) {
        ...
        this._lazyLoadHandler = Object(external_throttle_debounce_["throttle"])(200, this.handleLazyLoad);
