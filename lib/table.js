      ...
      class: [
        {
          ...
          "el-table--enable-row-hover":
            !_vm.noHover && !_vm.store.states.isComplex,
...
var mousewheel_mousewheel = function mousewheel(element, callback) {
  if (element && element.addEventListener) {
    element.addEventListener(external_normalize_wheel_default.a.getEventType(), function (event) {
...
function createStore(table) {
  ...
  store.toggleAllSelection = Object(external_throttle_debounce_["debounce"])(10, store._toggleAllSelection);
...
var scrollbar_width_ = __webpack_require__(35);
...
/* harmony default export */ var table_body = ({
  ...
  watch: {
    ...
    'store.states.hoverRow': function storeStatesHoverRow(newVal, oldVal) {
      ...
      window.requestAnimationFrame(function () {
        var trs = _this2.$refs.tbody.children;
        var rows = [].filter.call(trs, function (row) {
  ...
  methods: {
    ...
    handleMouseEnter: Object(external_throttle_debounce_["debounce"])(30, function (index) {
      this.store.commit('setHoverRow', index);
    }),

    handleMouseLeave: Object(external_throttle_debounce_["debounce"])(30, function () {
      ...
      return h(
        'tr',
        {
          ...
          on: {
            ...
            'mouseenter': this.noHover ? util_["noop"] : function (_) {
              return _this3.handleMouseEnter($index);
            },
            'mouseleave': this.noHover ? util_["noop"] : this.handleMouseLeave
          }
        },
              ...
              return h(
                ...
                [h(
                  ...
                  [column.renderHeader ? column.renderHeader.call(_this._renderProxy, h, { column: column, $index: cellIndex, store: _this.store, _self: _this.$parent.$vnode.context }) : column.label, column.sortable ? h(
                    ...
                    [h('i', { 'class': [_this.filterIcon, column.filterOpened ? 'is-open' : ''] })]
                  ) : '']
                )]
              );
...
/* harmony default export */ var tablevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    syncPostion: Object(util_["rafThrottle"])(function () {
      ...
      var scrollLeft = bodyWrapper.scrollLeft,
          ...
          offsetWidth = bodyWrapper.offsetWidth,
          scrollWidth = bodyWrapper.scrollWidth;
