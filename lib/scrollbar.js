...
/* harmony default export */ var main = ({
  ...
  props: {
    native: {
      ...
      default: function _default() {
        return Object(util_["isChromeLike"])() && !!(window.CSS && window.CSS.supports && window.CSS.supports('overflow: overlay'));
      }
    },
    wrapStyle: {},
    wrapClass: {},
  ...
  render: function render(h) {
    var gutter = this.native ? 0 : scrollbar_width_default()();
    var staticStyle = {
    ...
    h('div', {
      staticStyle: staticStyle, // JSX 不支持 staticStyle
      ref: 'wrap',
    ...
    return h(
      ...
      [!this.native ? [h('div', {
        staticStyle: staticStyle, // 见上
        ref: 'wrap',
        style: this.wrapStyle,
        staticClass: 'el-scrollbar__wrap' + (gutter ? '' : ' el-scrollbar__wrap--hidden-default'),
        class: this.wrapClass,
        on: { scroll: this.handleScroll }
      }, [view]), this.orientation !== 'vertical' && h(src_bar, {
        attrs: {
          move: this.moveX,
          size: this.sizeWidth }
      }), this.orientation !== 'horizontal' && h(src_bar, {
        attrs: {
          vertical: true,
          move: this.moveY,
