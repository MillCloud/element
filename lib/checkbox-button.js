...
/* harmony default export */ var checkbox_buttonvue_type_script_lang_js_ = ({
  ...
  computed: {
    model: {
      get: function get() {
        return this.elCheckboxGroup ? this.store : this.value !== undefined ? this.value : this.selfModel;
      },
      set: function set(val) {
        if (this.elCheckboxGroup) {
          this.isLimitExceeded = false;
          this.elCheckboxGroup.min !== undefined && val.length < this.elCheckboxGroup.min && (this.isLimitExceeded = true);

          this.elCheckboxGroup.max !== undefined && val.length > this.elCheckboxGroup.max && (this.isLimitExceeded = true);
    ...
    size: function size() {
      return !!this.elCheckboxGroup && this.elCheckboxGroup.checkboxGroupSize || this._elFormItemSize || (this.$ELEMENT || {}).size;
    },


    /* used to make the isDisabled judgment under max/min props */
    isLimitDisabled: function isLimitDisabled() {
      var _elCheckboxGroup = this.elCheckboxGroup,
          max = _elCheckboxGroup.max,
          min = _elCheckboxGroup.min;

      return !!(max || min) && this.model.length >= max && !this.isChecked || this.model.length <= min && this.isChecked;
    },
    isDisabled: function isDisabled() {
      return (this.elCheckboxGroup ? this.elCheckboxGroup.disabled || this.isLimitDisabled : false) || Object(util_["calcDisabled"])(this.disabled, this.elForm);
    }
  },
  methods: {
    ...
    handleChange: function handleChange(ev) {
      ...
      this.$nextTick(function () {
        if (_this.elCheckboxGroup) {
          _this.dispatch('ElCheckboxGroup', 'change', [_this.elCheckboxGroup.value]);
        }
      });
    }
  },
