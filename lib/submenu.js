...
var menu_mixin = __webpack_require__(33);
...
var poperMixins = Object(vue_popper_["customerPopper"])('appendToBody');
...
/* harmony default export */ var submenuvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    handleMouseleave: function handleMouseleave() {
      ...
      clearTimeout(this.timeout);
      this.timeout = setTimeout(function () {
        !_this2.mouseInChild && _this2.rootMenu.closeMenu(_this2.index);
      }, this.hideTimeout);
  ...
  created: function created() {
    ...
    this.$on('mouse-enter-child', function () {
      _this3.mouseInChild = true;
      clearTimeout(_this3.timeout);
    });
    this.$on('mouse-leave-child', function () {
      _this3.mouseInChild = false;
      clearTimeout(_this3.timeout);
    });
  },
        ...
        'div',
        {
          ...
          on: {
            'mouseenter': function mouseenter($event) {
              return _this4.handleMouseenter($event, 100);
            },
