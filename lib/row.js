...
/* harmony default export */ var row = ({
  ...
  render: function render(h) {
    ...
    var margin = this.gutter ? '-' + this.gutter / 2 + 'px' : null;

    return h(
      this.tag,
      {
        staticClass: 'el-row',
        'class': (_ref = {}, _ref['is-justify-' + this.justify] = this.justify !== 'start', _ref['is-align-' + this.align] = this.align !== 'top', _ref['el-row--flex'] = this.type === 'flex', _ref),
