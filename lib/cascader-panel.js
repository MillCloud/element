...
var cascader_panelvue_type_template_id_34932346_render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "el-cascader-panel",
      class: { "is-bordered": _vm.border },
    ...
    _vm._l(_vm.menus, function(menu, index) {
      return _c("cascader-menu", {
        ...
        ref: "menu",
        refInFor: true,
        attrs: { index: index, nodes: menu, optionMaxWidth: _vm.optionMaxWidth }
      })
    }),
    1
  )
...
var node_Node = function () {
  ...
  _createClass(Node, [{
    ...
    get: function get() {
      ...
      if (lazy) {
        var isLeaf = data[leafKey] != null ? data[leafKey] : loaded ? !children.length : false;
